...
```{r, vis-MB-BRF-y, fig.width=7, fig.height=5, fig.cap = "Figure G.1: Predicted (scenario: aabbyytt)"}
vis_MB_BRF_y
```
...
## Appendix I: The Relationship between Yield and EONR Prediction Performances (scenario: aabbyytt)

```{r, vis-RMSE-y-eonr, fig.width=5, fig.height=5, fig.cap = "Figure I.1: The Relationship between Yield and EONR Prediction Performances"}
vis_RMSE_y_eonr
```
