...
Figure E.1 plots the predicted yields against the true yield without error in one of the one thousand simulation rounds by ML method and modeling scenario. The predicted points clustered around the red 1-to-1 line, meaning that the prediction-oriented ML methods predicted yields well.
