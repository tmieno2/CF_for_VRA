...
Using those yield datasets, we conducted one hundred rounds of simulations. The results of EONR estimation and yield prediction are shown in Table XX. (what about CNN reuslts??)


```{r report-table-optN-low, tab.cap = "Table I.1: Mean RMSE (kg/ha) estimation and profit-deficit ($/ha) by ML method and modeling scenario on low and high degree of yield disturbance datasets"}
...
```{r report-table-optN-low, tab.cap = "Table I.2: Mean RMSE of yield prediction (kg/ha) by ML method and modeling scenario on low and high degree of yield disturbance datasets"}
