...
Thank you so much for your comments. By addressing them, we believe the manuscript is improved significantly. You can find our replies to your comments. Your comments are in bold, and out replies are in a regular font.
...
<span style="color:blue">  
Explanations for those numbers are added as a footnote to the figure. The figure is now in the appendix and called Figure A.1. 
</span>
...
<span style="color:blue">  
We realized that section 3.1 also had a uninformative title. Therefore, we changed it to "Training Models and Estimating Site-specific EONRs". Further, the title of sections 3.2.1 and 3.2.2 were changed to "Estimation of site-specific EONRs by RF, BRF, and CNN" and "Estimation of site-specific EONRs by CF", respectively. 
</span>
...
<span style="color:blue">  
The title of 4.1 was changed to "Comparison of EONR estimation accuracy" to reflect its contents. The title of section 4.2 was changed to "The relationship between yield and EONR prediction performances". They acurrately reflect what they describe.
</span>
...
As explained in section 4.1, CNN failed to predict site-specific EONR because the estimated yield response function were always linear (please see the Table 1). Therefore, we thought that visualizing the CNN results are not insightful. However, we have decided to include CNN results to Figures 8, 9, and 10 in the previous version. The figures are now Figures 3, 4, and 5. 
