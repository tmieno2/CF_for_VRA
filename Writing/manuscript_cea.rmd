...
```{r table-optN, tab.cap = "Mean RMSE of EONR (kg/ha) estimation and profit-deficit ($/ha) by ML methods and modeling scenarios"}
report_table_optN
```
