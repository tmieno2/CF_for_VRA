...
Elementary calculus shows that the necessary condition for maximization is, that $p (\partial f(I, \mathbf{c})/\partial I) - w =0$, which implicitly defines the economically optimal input application rate as a function of prices and soil/field characteristics, and may be arranged as \@ref(eq:eqn2):
