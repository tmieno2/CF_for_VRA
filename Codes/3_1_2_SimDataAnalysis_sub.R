...
res_cnn_onEval_low <- 
    list.files(
        path = here("Shared/Results/CNN_rawRes_low"),
...
# saveRDS(slope_dt_low, here("Shared/Results/CNN_EONR_anlaysis/cnn_response_slope_all_low.rds"))

slope_dt_low <- readRDS(here("Shared/Results/CNN_EONR_anlaysis/cnn_response_slope_all_low.rds"))
...
saveRDS(cnn_summry_bySim_low, here("Shared/Results/for_writing/cnn_summry_bySim_low.rds"))
...
saveRDS(allML_summary_bySim_low, here("Shared/Results/for_writing/allML_summary_bySim_low.rds"))
...
saveRDS(forest_summary_bySim_high, here("Shared/Results/for_writing/forest_summary_bySim_high.rmd"))
...
res_cnn_onEval_high <- 
    list.files(
        path = here("Shared/Results/CNN_rawRes_high"),
...
saveRDS(slope_dt_high, here("Shared/Results/CNN_EONR_anlaysis/cnn_response_slope_all_high.rds"))
...
saveRDS(cnn_summry_bySim_high, here("Shared/Results/for_writing/cnn_summry_bySim_high.rds"))
...
saveRDS(allML_summary_bySim_high, here("Shared/Results/for_writing/allML_summary_bySim_high.rds"))
