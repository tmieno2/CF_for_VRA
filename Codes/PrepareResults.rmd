...
# --- MB function to N --- #
vis_res_y <- ggplot(res_y_dt[variable=="Yield"]) +
  geom_line(aes(x=N, y=value, color=factor(group))) +
...
+ true yield response curves for two sites within a field
+ points true yield evaluated at the N rate that was actually applied at the site
+ RF-estimated yield at all the potential experimental rates including the actual rate that was applied
