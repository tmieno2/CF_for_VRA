...
pi_symb <- as_paragraph("\U1D70B\U0302", as_sub(as_i("def")))
pi_symb[[1]]$font.family <- "Cambria Math"
...
report_table_optN_train <-
  ...
  # font(i = 2, j = c(4, 7, 10, 13), fontname = "Cambria Math", part = "header") %>%
  compose(i = 2, j = c(4, 7, 10, 13), part = "header", value = pi_symb) %>%
  hline_bottom(part = "all") %>%
  hline_top(part = "header") %>%
  align(align = "center", part = "all") %>%
  align(j = 1, align = "left", part = "all") %>%
  ...
  compose(value = as_paragraph("Note: "), part = "footer") %>%
  footnote(part = "body", ref_symbols = NA, inline = T, sep = "",
    value = pi_symb
  ) %>%
  footnote(part = "body", ref_symbols = NA, sep = "", inline = T,
    value = as_paragraph(" indicates profit-deficit ($/ha) relative to the true maximum profit at the subplot level. The maximized profit is the profit under the true yield response functions evaluated at ", as_i("\U004E\U2071"), as_sub(as_i("opt")), ".")
  ) %>%
  # footnote(
...
table_optN_low_high <-
  ...
  # font(i = 2, j = c(5, 8, 11, 14), fontname = "Cambria Math", part = "header") %>%
  compose(i = 2, j = c(5, 8, 11, 14), part = "header", value = pi_symb) %>%
  hline_bottom(part = "all") %>%
  hline_top(part = "header") %>%
  align(align = "center", part = "all") %>%
  align(j = 1, align = "left", part = "all") %>%
