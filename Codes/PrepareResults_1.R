...
field_plot_sf <- readRDS("./Shared/Results/for_writing/sample_field_plot_sf.rds")
# === subplot-level field data set  === #
field_subplot_sf <- readRDS("./Shared/Results/for_writing/sample_field_subplot_sf.rds")
# === cell-level field data set  === #
field_cell_sf <- readRDS("./Shared/Results/for_writing/sample_field_cell_sf.rds")
...
figure_te <- readRDS("./Shared/Results/for_writing/dt_TEcomparison.rds")%>%
    .[, Method:= case_when(
        Method=="RF" ~ "RF",
        Method=="BRF" ~ "BRF",
        Method=="CF_base" ~ "CF-base")] %>%
